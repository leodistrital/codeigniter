<div class="form2-popup" id="preguntas">
    <form action="preguntas.php" class="form2-container">
        ...
        <div class="form2-field">
            ...
            <p style="margin: 0px">
                <input type="text" readonly placeholder="Ingresa tus nombres y apellidos" name="nombre"
                    value="<?= $datosUsuario['nombre'] ?>">
            </p>
            <label for="psw"><b>Concesionario</b></label>
            <p style="margin: 0px">
                <input type="text" readonly placeholder="Concesionario" name="concesionario"
                    value="<?= $datosUsuario['nombreConcesionario'] ?>">
            </p>
            <label for="psw"><b>Correo electrónico</b></label>
            <!--input type="text" placeholder="Correo" name="correo"-->
            <p style="margin: 0px"><input type="text" placeholder="Ingresa tu e-mail" name="correo"
                    value="<?= $datosUsuario['email'] ?>"></p>
        </div>
        <br>
        <div class="form2-field">
