...
<div class="contEMenu">
    <nav class="eMenu">
        ...
        <button type="button" class="rbtn btnEMenu toggleDiv cw" data-id="divEMenu">
            <?= $anionConsulta ?>
        </button>
