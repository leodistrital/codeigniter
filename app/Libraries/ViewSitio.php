...
use App\Models\web\MenuWebModel;
...
class ViewSitio
{
    ...
    {
        $menuModel = new MenuWebModel();
        $dataMenu = $menuModel->listatardatos();


        $InternasWebModel = new InternasWebModel();
        $dataInternas = $InternasWebModel->listatardatos();

        $frecuentesWebModel = new Preguntas_frecuentesWebModel();
        $frecuentesWebModelData = $frecuentesWebModel->listatarmenu();

        return view('components/cabezote/menu', ['dataMenu' => $dataMenu, 'dataInternas' => $dataInternas, 'frecuentesWebModelData' => $frecuentesWebModelData]);
    }
}
