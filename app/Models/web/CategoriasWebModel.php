...
class CategoriasWebModel extends Model
{
	...
	protected $allowedFields        = ["nom_cat","relacion_cat","orden_cat","ord_cat","imp_cat","cod_sim_cat","annio_cat","fec_crea","fec_modif","usu_acce","reg_eli","slu_cat"];
...
/* fecha de creacion: 12-29-2023 03:38:32 pm */