...
class PersonasApiModel extends Model
{
	...
	protected $allowedFields = ["cod_per as id", "cod_tit_per", "nom_per", "ape_per", "cod_gen_per", "pro_per", "cod_civ_per", "mai_per", "coy_per", "cod_emp_per", "dsc_per", "car_per", "tof_per", "obs_per", "twt_per", "cel_per", "cod_dep_per", "cod_cui_per", "dir_per", "sec_per", "temp_per", "codigo_temporal", "dir_corr_per", "tipo_dir_per", "cod_dir_per", "cod_suc_per", "asis_per", "est_coy_per", "reg_per", "hab_per", "sin_dirc_per", "wha_per", "fec_crea", "fec_modif", "usu_acce", "reg_eli", 'updated_at'];
	...
	public function listatardatos($id = 0)
	{
		...
		if ($id == 0) {
			...
			$data['usuario'] = $this->buscarusu($data['usu_acce']);
		}
	...
	public function buscarusu($id)
	{
		...
		$data = $user->where('cod_usu', $id)->first();
		// echo "++++";
		// print_r($data);
		// echo "++++";
		if (empty ($data))
			return '';
		return $data['nombre_usu'];
	}
	...
	{
		$array = ["cod_per as id ", "nom_per", "ape_per", 'updated_at', 'usu_acce', '( select nombre_usu from usuario where cod_usu=personas.usu_acce ) as usuario'];
	...
	public function reporte($request)
	{
		...
		$array = ["nom_eve as Evento", 'nom_sec as sector', 'nom_seg as segmento', "(select nom_op_para from parametros where val_op_para = cod_tit_per and nom_para='titulo_persona' limit 1) as Titulo", "nom_per as nombres", "ape_per as apellidos", "mai_per as Email", "cel_per as celular", "wha_per as whatsapp", "pro_per as profesion", "tof_per as fijo", "dir_per as direccion residencia", "dir_per as direccion correspondencia", "nom_dep as departamento", "nom_mun as ciudad", "nom_emp as empresa", "car_dpe as cargo", "tel_dpe as telefono", "obs_per as observaciones", "hab_per as habeas"];
