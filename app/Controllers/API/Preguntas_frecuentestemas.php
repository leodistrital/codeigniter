...
use App\Models\api\Preguntas_frecuentesTemasApiModel;
use CodeIgniter\RESTful\ResourceController;

class Preguntas_frecuentestemas extends ResourceController
{
    protected $format = 'json';

    public function __construct()
    {
        $this->modelName = new Preguntas_frecuentesTemasApiModel();
    }
